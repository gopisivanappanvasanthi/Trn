...
gulp.task("default", gulp.series(Publish_All_Projects, Apply_xml_Transform, Publish_Transforms, Sync_Unicorn), function (callback) {
...
function Publish_All_Projects(callback) {
...
gulp.task("Publish-All-Projects",
    function (callback) {
        Publish_All_Projects(callback);
    });

function Apply_xml_Transform() {
...
function Sync_Unicorn(callback) {
    var options = {};
